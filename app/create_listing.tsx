 ...
 */
import { ImagePickerAsset, launchImageLibraryAsync, MediaTypeOptions, requestMediaLibraryPermissionsAsync } from 'expo-image-picker';
...
export default function CreateListingScreen() {
  ...
  const handlePickImages = async () => {
    ...
    if (!result.canceled) {
      setImages(result.assets.map((asset: ImagePickerAsset) => asset.uri));
    }
  };
